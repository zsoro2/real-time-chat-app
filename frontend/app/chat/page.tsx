/**
 * v0 by Vercel.
 * @see https://v0.dev/t/EwR0KuoJzAv
 */
            ...
            <div className="flex flex-col gap-4">
              <div className="flex items-start gap-2">
                ...
                <div className="grid gap-1">
                  ...
                  <div className="line-clamp-1 text-sm">Hello! How are you today?</div>
                </div>
              </div>
              <div className="flex items-start gap-2">
                <Avatar>
                ...
                <div className="grid gap-1">
                  ...
                  <div className="line-clamp-1 text-sm">I'm good, thanks! How about you?</div>
                </div>
              </div>
            </div>
          </div>
